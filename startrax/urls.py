...
from .views import home_page_view, register, AlbumCreateView, AlbumDeleteView
...
urlpatterns = [
    ...
    path('album/<int:pk>/delete/', AlbumDeleteView.as_view(), name='album_delete'),  # Add this line
]